                                    ...
                                    <div className="row">
                                        <div className="col-xl-7">
                                            <div className="main-slider__content">
                                                <h2>Explore <span> and</span> Join Our Mission <br /> for the Blinds.</h2>
                                                <p>To make them proud and responsible citizens of India</p>
                                                <Link to={process.env.PUBLIC_URL + `/about`} className="thm-btn main-slider__btn">About Us</Link>
                                    ...
                                    <div className="row">
                                        <div className="col-xl-7">
                                            <div className="main-slider__content">
                                                ...
                                                <Link to={process.env.PUBLIC_URL + `/about`} className="thm-btn main-slider__btn">Learn more</Link>
                                                <div className="main-slider-arrow">
                                                    <img src={publicUrl+"assets/images/shapes/main-slider-shape-1.png"} className="float-bob-x" alt="" />
                                                </div>
                                            </div>
                            ...
                            <SwiperSlide className="swiper-slide">
                                ...
                                <div className="container">
                                    <div className="row">
                                        <div className="col-xl-7">
                                            <div className="main-slider__content">
                                                <h2>Give the <span>Most of your</span> Help <br /> for the Blinds.</h2>
